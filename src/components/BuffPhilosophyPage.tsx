...
במשחקי וידאו, "Buff" הוא בונוס שמחזק את הדמות באופן זמני ומאפשר לה להתמודד עם אתגרים שנראו בלתי אפשריים. זה בדיוק מה שאנחנו רוצים לתת לילד שלכם.
...
עבור מוח עם ADHD, העתיד הרחוק הוא מופשט ולא מוחשי. פרסים גדולים "בעוד חודש" אינם מניעים - הם מרגישים כמו נצח.
...
אנחנו יודעים כמה קשה לראות את הילד מתמודד עם תסכול. לכן בנינו מערכת שיוצרת "נמל מבטחים" רגשי - מקום בו הילד לא יכול להפסיד.
...
אנחנו יודעים שהרבה מהמאמץ של הילד שלכם הוא "שקוף" - הוא לא נראה לעין. להתגבר על הדחף לקום מהכיסא, להתאפק מלהגיב, להישאר ממוקד - כל אלה דורשים מאמץ עצום שלא מתועד במשימות.
...
ילדים עם ADHD צורכים יותר אנרגיה מנטלית במהלך היום. הם "רצים מרתון כשאחרים רצים ספרינט". לכן חיוני להתאים את הציפיות לסוג היום.
...
אחד הלקחים החשובים ביותר שלמדנו מעבודה עם ילדים עם ADHD הוא שיעדים גבוהים מדי הורסים מוטיבציה.
