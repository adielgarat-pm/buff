...
השפה הזו אינה גימיק - היא יוצרת חיבור רגשי עמוק והופכת את השגרה המאתגרת להרפתקה שהילד רוצה להיות חלק ממנה.`,
      buffInsight: 'מחקרים בתחום התפקודים הניהוליים מלמדים שמוטיבציה פנימית נבנית כאשר הפעילות מרגישה משמעותית ומהנה לילד עצמו. שפת גיימינג מוכרת ממזערת התנגדות ומגבירה מעורבות אצל ילדים עם קשיי קשב וריכוז.',
...
השיטה הזו יוצרת "גשר דופמין" - פרסים קטנים ונגישים כל יומיים בונים התמדה וביטחון עצמי, בעוד הפרסים הגדולים מלמדים דחיית סיפוקים בצורה הדרגתית.`,
      buffInsight: 'מחקרים מראים שילדים עם ADHD מגיבים טוב יותר לחיזוקים מיידיים וקרובים. פרסים קטנים ותכופים יעילים יותר מפרס גדול אחד רחוק. השילוב של שני הסוגים בונה גם מוטיבציה מיידית וגם יכולת לדחיית סיפוקים.',
...
ההתמקדות תמיד במה שכן הושג. זה מפחית התנגדויות ובונה ביטחון עצמי.`,
      buffInsight: 'מחקרים מראים שילדים עם ADHD מגיבים טוב יותר לחיזוק חיובי מאשר לעונשים. חיזוק שלילי יוצר חרדה ונמנעות, בעוד חיזוק חיובי בונה ביטחון עצמי ומוטיבציה פנימית לטווח ארוך.',
...
הבונוס הזה יוצר הזדמנות לשיחה חיובית, מחזק את הקשר בינכם, ומלמד את הילד שמאמץ מוערך - גם כשהתוצאות לא מושלמות. זו גם הזדמנות להפגין גמישות כהורים.`,
      buffInsight: 'אינטראקציה חיובית בין הורה לילד היא מרכיב קריטי בפיתוח תפקודים ניהוליים. הבונוס משמש כ"גשר רגשי" ומחזק את תחושת ה-Agency של הילד - ההרגשה שהוא יכול להשפיע על מציאות חייו.',
...
ההתאמה הזו מונעת שחיקה. היא מלמדת את הילד שגם מנוחה היא חלק מהתוכנית, ושציפיות משתנות בהתאם להקשר - שיעור חשוב לחיים.`,
      buffInsight: 'ילדים עם ADHD זקוקים למבנה יציב, אבל גם לגמישות מותאמת. היכולת לזהות "סוג יום" ולהתאים ציפיות מפחיתה עומס קוגניטיבי ומונעת את תחושת הכישלון שנובעת מציפיות לא ריאליסטיות.',
...
זה יוצר "רצף ניצחונות" (Winning Streak) שבונה ביטחון עצמי במקום לקבע תחושת כישלון כרונית.`,
      buffInsight: 'יעדים לא ריאליסטיים הם אחד הגורמים העיקריים לנשירה ממערכות התנהגותיות. כלל ה-70% מבוסס על עקרון "הצלחה בנויה על הצלחה" - כל הישג מחזק את המוטיבציה להמשך וגורם לילד לרצות להמשיך לנסות.',
  ...
  const handleStartClick = () => {
    ...
    // If onboarding callback provided, trigger it
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                מערכת שנבנתה בשיתוף פעולה עם מומחים בתחום, מבוססת על עקרונות לחיזוק תפקודים ניהוליים שהוכחו מחקרית.
              </p>
            </div>
          </div>
        </div>
