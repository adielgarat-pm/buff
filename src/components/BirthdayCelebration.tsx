          ...
          >
            ...
            {age && (
              ...
              >
                ...
                <span className="text-lg font-bold text-primary">{age} שנים!</span>
              </motion.div>
            )}
            ...
            >
              שיהיה לך יום מדהים מלא בשמחה והצלחות! ✨
            </motion.p>
            ...
            >
              <Button
                onClick={onDismiss}
                className="w-full h-12 text-lg font-bold rounded-2xl bg-gradient-to-r from-primary to-yellow-500 hover:opacity-90"
              >
                תודה! 🥳
              </Button>
            </motion.div>
