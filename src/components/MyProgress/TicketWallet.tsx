    ...
    <>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={t('tickets.infoTitle')}
            >
              <HelpCircle className="w-4 h-4 text-primary" />
            </button>
          </div>
          <span className="text-sm text-muted-foreground">
            {restTickets}/{maxTickets} {t('tickets.available')}
          </span>
        </div>
          ...
          {Array.from({ length: maxTickets }).map((_, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={isAvailable ? { y: -8, scale: 1.05, rotate: 0 } : undefined}
                className="absolute"
                style={{
              ...
              >
                <div
                  ...
                  style={{
                    clipPath: `polygon(
                      0% 0%, 100% 0%, 100% 35%, 96% 35%, 96% 40%, 100% 40%, 
                      100% 60%, 96% 60%, 96% 65%, 100% 65%, 100% 100%, 
                      0% 100%, 0% 65%, 4% 65%, 4% 60%, 0% 60%, 
                      0% 40%, 4% 40%, 4% 35%, 0% 35%
                    )`,
                  }}
                >
      ...
      >
        {restTickets === 0 
          ...
          : restTickets === 1 
            ? t('tickets.oneLeft')
            : `${t('tickets.multiple')} (${restTickets})`
        }
      </motion.p>
      </div>
