...
const INSIGHT_TEMPLATES: Record<string, Omit<InsightCard, 'id' | 'completionRate'>> = {
  ...
  'medication-low': {
    ...
    titleHe: 'תזכורת לתרופות',
    description: 'Medication tasks have been missed more often. This is important for consistency.',
    descriptionHe: 'משימות תרופות הוחמצו לעתים קרובות יותר. זה חשוב לעקביות.',
    suggestion: 'Link medication to an existing habit (breakfast, brushing teeth). Visual cues like a pillbox by the toothbrush can help.',
    suggestionHe: 'קשרו תרופות להרגל קיים (ארוחת בוקר, צחצוח שיניים). רמזים חזותיים כמו קופסת תרופות ליד מברשת השיניים יכולים לעזור.',
    strategyType: 'environmental',
    icon: '💊',
  },
  'hygiene-low': {
    type: 'task',
    severity: 'suggestion',
    title: 'Hygiene Transitions',
    titleHe: 'מעברי היגיינה',
    description: 'Hygiene tasks like showering have been challenging. Sensory transitions can feel overwhelming.',
    descriptionHe: 'משימות היגיינה כמו מקלחת היו מאתגרות. מעברים חושיים יכולים להרגיש מציפים.',
    suggestion: 'Add a "Dopamine Boost": Play a favorite podcast or playlist during shower time. Making it enjoyable reduces resistance.',
    suggestionHe: 'הוסיפו "בוסט דופמין": נגנו פודקאסט או פלייליסט אהוב בזמן המקלחת. להפוך לזה למהנה מפחית התנגדות.',
    strategyType: 'self-regulation',
    icon: '🚿',
  },
  'homework-low': {
    type: 'task',
    severity: 'suggestion',
    title: 'Task Initiation Challenge',
    titleHe: 'אתגר התחלת משימות',
